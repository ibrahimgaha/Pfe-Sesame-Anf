...
@Component({
  selector: 'app-details-demand-ret-conf',
  templateUrl: './details-demand-ret-conf.component.html',
  styleUrls: ['./details-demand-ret-conf.component.css']
})
export class DetailsDemandRetConfComponent implements OnInit {
  demandeId: number;
  demandeDetails: any;
