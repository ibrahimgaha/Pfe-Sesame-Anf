...
@Component({
  selector: 'app-details-demand-conf',
  templateUrl: './details-demand-conf.component.html',
  styleUrls: ['./details-demand-conf.component.css']
})
export class DetailsDemandConfComponent implements OnInit {
