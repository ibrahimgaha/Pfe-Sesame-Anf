...
@Component({
  selector: 'app-creer-demande-temporelle',
  templateUrl: './creer-demande-temporelle.component.html',
  styleUrls: ['./creer-demande-temporelle.component.css']
})
export class CreerDemandeTemporelleComponent implements OnInit {
  ...
  SubmitDemandeMagnetic(demandeMagneticForm: NgForm) {
    ...
    this.demandeService.addNewDemandeControlle(demandeFormData).subscribe(
      (response) => {
        Swal.fire({
          position: "top-end",
          icon: "success",
